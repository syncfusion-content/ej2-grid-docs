...
To clear the selection in the component programmatically, you can use the [clearSelection](../../api-grid.html#clearSelection)  method. 
...
>* The `persistSelection` feature is not supported for cell selections in the Syncfusion ##Platform_Name## Grid component
